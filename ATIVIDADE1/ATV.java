...
public class ATV {
    ...
    System.out.println("raiz com exp e log e realint: " + (int) Math.round( Math.exp(((double)1/2)*Math.log(64))));
    System.out.println("\n");

    // imprima "\nraiz com exp e log sem realint: h',exp(1/2*log(64)) ;
    System.out.println("raiz com exp e log sem realint " + Math.exp(((double)1/2)*Math.log(64)));
    System.out.println("\n");

    //imprima "\n", formatar(sen(45*pi/180)+0.0001,3);
    System.out.println("imprima, formatar(sen(45*pi/180)+0.0001,3): " + formatar.format(Math.sin(45*Math.PI/180)+ 0.00013));
    System.out.println("\n");

    //imprima "\npotencia com exp e log e formatar: ",formatar(exp(3*log(8))+0.001,3);
     
    System.out.println("potencia com exp e log e formatar: " +formatar.format( StrictMath.exp(3*Math.log(8)+0.00013)));
    System.out.println("\n");
   ...
   System.out.println("raiz cubica: " + Math.exp(((double)1/3)*Math.log(8))+"\n");
   ...
   //imprima "\nabsoluto: ",abs(-8);
     ...
     //imprima "\nconvertendo para int 3/4: ",realint(314),"\n";
               System.out.println("convertendo para inteiro 3/4: " + (int) Math.round( (double) 3/4) +"\n");
