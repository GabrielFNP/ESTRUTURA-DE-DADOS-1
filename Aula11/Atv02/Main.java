...
public class Main {
    public static void main(String[] args) {
        /*
         * From group 1 to group 10 it'll be attended as people as the group number (55
         * people afterall).
         * After them, from group 11 to 14, the whole group will be attended. Finally,
         * to complete 100
         * patients attended in a day, in the last group (15th), only the half will be
         * attended.
         */
