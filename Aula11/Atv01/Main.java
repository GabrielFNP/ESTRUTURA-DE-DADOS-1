...
public class Main {
    public static void main(String[] args) {
        ...
        people.addEnd(new Person("Tulio Noia", "(11) 99400-2015", "Av. do Comercio", "333.601.287-22", 5));// 5
        people.addEnd(new Person("Paulo Noia", "(62) 99321-4300", "Rua Pedro Bento", "998.184.000-64", 6));// 6
