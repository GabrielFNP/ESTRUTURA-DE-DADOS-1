...
int ordem(int *pnum1, int *pnum2, int *pnum3)
{
	...
	else
	{
		...
		else if ((*pnum1<*pnum2 && * pnum1> * pnum3) || (*pnum1 > *pnum2 && *pnum1 < *pnum3))
		{
			meio = *pnum1;
		}
		else if (*pnum1 < *pnum2 && *pnum1 < *pnum3)
		{
			menor = *pnum1;
		}
		...
		else if ((*pnum2 > *pnum1 && *pnum2 < *pnum3) || (*pnum2<*pnum1 && * pnum2> * pnum3))
		{
			meio = *pnum2;
		}
		...
		else if ((*pnum3 > *pnum1 && *pnum3 < *pnum2) || (*pnum3<*pnum1 && * pnum3> * pnum2))
		{
			meio = *pnum3;
		}
		else if (*pnum3 < *pnum1 && *pnum3 < *pnum2)
		{
			menor = *pnum3;
		}
